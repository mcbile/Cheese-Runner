...
import { COLORS, MATERIAL_SETTINGS } from './snakeMaterials';
        ...
        <group ref={groupRef} scale={2} position-y={0.15}>
            ...
            <group ref={cobraBodyRef} position={[0, 0.2, 0]}>
                ...
                <mesh position={[0, -0.1, -0.6]} rotation={[Math.PI / 2, 0, 0]} castShadow>
                    ...
                    <meshStandardMaterial color={COLORS.BODY_GREEN} roughness={MATERIAL_SETTINGS.BODY_ROUGHNESS} metalness={MATERIAL_SETTINGS.BODY_METALNESS} />
                </mesh>
                <mesh position={[0.18, -0.1, -0.85]} rotation={[Math.PI / 2, 0, Math.PI / 2]} castShadow>
                    <torusGeometry args={[0.2, 0.08, 12, 20, Math.PI]} />
                    <meshStandardMaterial color={COLORS.BODY_DARK} roughness={MATERIAL_SETTINGS.BODY_ROUGHNESS} metalness={MATERIAL_SETTINGS.BODY_METALNESS} />
                </mesh>
                {/* Tail tip */}
                <mesh position={[0.35, -0.1, -0.95]} rotation={[0, -0.3, Math.PI / 2]}>
                    <coneGeometry args={[0.06, 0.25, 8]} />
                    <meshStandardMaterial color={COLORS.BODY_DARKER} roughness={MATERIAL_SETTINGS.NECK_ROUGHNESS} />
                </mesh>
                ...
                {[0, 0.8, 1.6, 2.4].map((angle, idx) => (
                    <mesh key={`coil-scale-${idx}`} position={[
                        ...
                        <meshStandardMaterial color={COLORS.SCALE_DARK} transparent opacity={MATERIAL_SETTINGS.SCALE_OPACITY} side={2} />
                    </mesh>
                ))}
                ...
                <mesh position={[0, 0.15, -0.3]} rotation={[Math.PI / 4, 0, 0]} castShadow>
                    ...
                    <meshStandardMaterial color={COLORS.BODY_GREEN} roughness={MATERIAL_SETTINGS.NECK_ROUGHNESS} metalness={MATERIAL_SETTINGS.NECK_METALNESS} />
                </mesh>
                {/* Belly - lighter underside */}
                <mesh position={[0, 0.13, -0.25]} rotation={[Math.PI / 4, 0, 0]} scale={[0.7, 1, 0.5]}>
                    <capsuleGeometry args={[0.1, 0.35, 6, 10]} />
                    <meshStandardMaterial color={COLORS.BELLY_LIGHT} roughness={MATERIAL_SETTINGS.BODY_ROUGHNESS} />
                </mesh>

                <mesh position={[0, 0.45, 0]} rotation={[-Math.PI / 6, 0, 0]} castShadow>
                    <capsuleGeometry args={[0.1, 0.35, 8, 12]} />
                    <meshStandardMaterial color={COLORS.BODY_LIGHT} roughness={MATERIAL_SETTINGS.NECK_ROUGHNESS} metalness={MATERIAL_SETTINGS.NECK_METALNESS} />
                </mesh>

                {/* Neck going to hood */}
                <mesh position={[0, 0.7, 0.18]} rotation={[-Math.PI / 3, 0, 0]} castShadow>
                    <capsuleGeometry args={[0.08, 0.22, 8, 10]} />
                    <meshStandardMaterial color={COLORS.BODY_LIGHT} roughness={MATERIAL_SETTINGS.NECK_ROUGHNESS} />
                </mesh>
                ...
                <group ref={cobraHoodRef} position={[0, 0.65, 0.15]}>
                    ...
                    <mesh scale={[1.9, 1.3, 0.35]} castShadow>
                        ...
                        <meshStandardMaterial color={COLORS.HOOD_GREEN} roughness={MATERIAL_SETTINGS.HOOD_ROUGHNESS} metalness={MATERIAL_SETTINGS.HOOD_METALNESS} />
                    </mesh>
                    ...
                    {[-0.15, -0.05, 0.05, 0.15].map((x, idx) => (
                        <mesh key={`rib-${idx}`} position={[x * 1.5, 0, 0.02]} scale={[0.15, 0.9, 0.1]}>
                            ...
                            <meshStandardMaterial color={COLORS.BODY_GREEN} roughness={MATERIAL_SETTINGS.NECK_ROUGHNESS} />
                        </mesh>
                    ))}
                    {/* Hood pattern - lighter inner area */}
                    <mesh position={[0, 0, 0.06]} scale={[1.5, 1.0, 0.25]}>
                        <sphereGeometry args={[0.17, 16, 12]} />
                        <meshStandardMaterial color={COLORS.HOOD_INNER} roughness={MATERIAL_SETTINGS.NECK_ROUGHNESS} />
                    </mesh>
                    {/* Hood markings - spectacle pattern (classic cobra) */}
                    <mesh position={[0, 0.08, 0.07]} scale={[0.08, 0.04, 0.01]}>
                        <boxGeometry args={[1, 1, 1]} />
                        <meshStandardMaterial color={COLORS.MARKING_BLACK} />
                    </mesh>
                    ...
                    <mesh position={[0.13, 0.05, 0.07]} scale={0.04}>
                        <circleGeometry args={[1, 16]} />
                        <meshStandardMaterial color={COLORS.MARKING_GOLD} />
                    </mesh>
                    <mesh position={[-0.13, 0.05, 0.07]} scale={0.04}>
                        <circleGeometry args={[1, 16]} />
                        <meshStandardMaterial color={COLORS.MARKING_GOLD} />
                    ...
                    <mesh scale={[2.0, 1.35, 0.2]} position={[0, 0, -0.01]}>
                        ...
                        <meshStandardMaterial color={COLORS.HOOD_EDGE} roughness={MATERIAL_SETTINGS.NECK_ROUGHNESS} />
                    </mesh>
                </group>
                ...
                <group ref={cobraHeadRef} position={[0, 0.88, 0.32]}>
                    ...
                    <mesh rotation={[Math.PI / 6, 0, 0]} castShadow>
                        ...
                        <meshStandardMaterial color={COLORS.HEAD_GREEN} roughness={MATERIAL_SETTINGS.HEAD_ROUGHNESS} metalness={MATERIAL_SETTINGS.HEAD_METALNESS} />
                    </mesh>
                    {/* Head scales - top */}
                    <mesh position={[0, 0.08, 0]} rotation={[-0.2, 0, 0]} scale={[0.9, 0.5, 0.8]}>
                        <sphereGeometry args={[0.1, 12, 10]} />
                        <meshStandardMaterial color={COLORS.HEAD_DARK} roughness={MATERIAL_SETTINGS.HEAD_TOP_ROUGHNESS} />
                    </mesh>
                    {/* Snout - more defined */}
                    <mesh position={[0, -0.02, 0.13]} rotation={[Math.PI / 8, 0, 0]} scale={[0.85, 0.6, 1.1]}>
                        <sphereGeometry args={[0.08, 12, 10]} />
                        <meshStandardMaterial color={COLORS.HEAD_GREEN} roughness={MATERIAL_SETTINGS.HEAD_ROUGHNESS} />
                    </mesh>
                    {/* Nostrils */}
                    <mesh position={[0.03, -0.01, 0.19]} scale={0.015}>
                        <sphereGeometry args={[1, 8, 8]} />
                        <meshStandardMaterial color={COLORS.NOSTRIL} />
                    </mesh>
                    <mesh position={[-0.03, -0.01, 0.19]} scale={0.015}>
                        <sphereGeometry args={[1, 8, 8]} />
                        <meshStandardMaterial color={COLORS.NOSTRIL} />
                    ...
                    <mesh position={[0.075, 0.04, 0.065]} scale={1.3}>
                        ...
                        <meshStandardMaterial color={COLORS.EYE_RING} side={2} />
                    </mesh>
                    <mesh position={[-0.075, 0.04, 0.065]} scale={1.3}>
                        <ringGeometry args={[0.035, 0.045, 16]} />
                        <meshStandardMaterial color={COLORS.EYE_RING} side={2} />
                    ...
                    <mesh position={[0, 0.07, 0.06]} scale={[1.2, 0.3, 0.6]} rotation={[0.3, 0, 0]}>
                        ...
                        <meshStandardMaterial color={COLORS.HEAD_DARK} roughness={MATERIAL_SETTINGS.HEAD_ROUGHNESS} />
                    </mesh>
                    ...
                    <group ref={cobraTongueRef} position={[0, -0.05, 0.18]}>
                        <mesh>
                            ...
                            <meshStandardMaterial color={COLORS.TONGUE_RED} roughness={MATERIAL_SETTINGS.TONGUE_ROUGHNESS} />
                        </mesh>
                        ...
                        <mesh position={[-0.02, 0, 0.08]} rotation={[0, -0.4, 0]}>
                            ...
                            <meshStandardMaterial color={COLORS.TONGUE_RED} />
                        </mesh>
                    </group>
                </group>
                ...
                {[0.15, 0.35, 0.5].map((yPos, idx) => (
                    <group key={`side-scales-${idx}`}>
                        <mesh position={[0.08, yPos, -0.15 + idx * 0.08]} rotation={[Math.PI / 4, Math.PI / 4, 0]} scale={0.03}>
                            <planeGeometry args={[1, 1]} />
                            <meshStandardMaterial color={COLORS.SCALE_SIDE} transparent opacity={MATERIAL_SETTINGS.SCALE_SIDE_OPACITY} side={2} />
                        </mesh>
                        <mesh position={[-0.08, yPos, -0.15 + idx * 0.08]} rotation={[Math.PI / 4, -Math.PI / 4, 0]} scale={0.03}>
                            <planeGeometry args={[1, 1]} />
                            <meshStandardMaterial color={COLORS.SCALE_SIDE} transparent opacity={MATERIAL_SETTINGS.SCALE_SIDE_OPACITY} side={2} />
            ...
            <mesh geometry={SHADOW_SNAKE_GEO} position={[0, 0.02, -0.25]} rotation={[-Math.PI / 2, 0, 0]} scale={[1.5, 2.2, 1]}>
                <meshBasicMaterial color={COLORS.SHADOW} opacity={MATERIAL_SETTINGS.SHADOW_OPACITY} transparent />
            </mesh>
        </group>
    );
};
